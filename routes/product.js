...
const {//metoda za kreiranje produkta,citanje producta by id metoda, brisanje produkta, update produkta, dohvat svih produkata i doh. related produkata
    create,
    productById,
    read,
    remove,
...
router.post('/product/create/:userId',//prvo se pozivaju svi navedeni middlwarei a tek onda metoda create
            requireSignin,
            isAdmin,
            isAdmin,
            create
