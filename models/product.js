...
const productSchema=new mongoose.Schema({//definiranje pravila, odnosno definiranje property-a sa tipovima i zahtjevima
    name:{
        type: String,
    ...
    quantity:{//kolicina dostupnog proizvoda, kako se bude prodavalo smanjivat ce se broj
        type:Number
    },
    sold:{// broj prodanog proizvoda
        type:Number,
